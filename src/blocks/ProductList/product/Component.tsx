...
export const ProductCard: React.FC<ProductCardProps> = async ({ product }) => {
  ...
  const replacesProducts =
    product.replaces !== null && product.replaces !== undefined && product.replaces.length !== 0
  return (
    <>
      <Card className="h-full flex flex-col">
        <CardHeader>
          <div className="flex flex-col xl:flex-row justify-between">
            <div className="flex items-center justify-center">
              ...
              />
              <H2 className="mx-3 pb-0">{product.name}</H2>
            </div>
        ...
        <div className="flex flex-col justify-between h-full gap-2">
          <CardDescription className="line-clamp-6 h-fit m-6">
            {product.description}
          </CardDescription>
